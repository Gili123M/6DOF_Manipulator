...
def main():
    ...
    lst_joint_angles_1 = [math.radians(0), math.radians(0), math.radians(0), math.radians(0), math.radians(0), math.radians(0)]
    lst_joint_angles_2 = [math.radians(25.7831), math.radians(-69.3278), math.radians(79.9963), math.radians(0), math.radians(0), math.radians(-6.4056)]
    lst_joint_angles_3 = [math.radians(25.7831), math.radians(-69.3278), math.radians(79.9963), math.radians(0), math.radians(0), math.radians(-49.8475)]
